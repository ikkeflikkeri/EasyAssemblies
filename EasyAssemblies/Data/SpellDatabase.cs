...
namespace EasyAssemblies.Data
{
    ...
    public static class SpellDatabase
    {
        ...
        static SpellDatabase()
        {
            ...
            DangerousSpells.Add(new SpellDatabaseItem { ChampionName = "Bard", Slot = SpellSlot.Q });
            DangerousSpells.Add(new SpellDatabaseItem { ChampionName = "Bard", Slot = SpellSlot.R });
            ...
            DangerousSpells.Add(new SpellDatabaseItem { ChampionName = "Nasus", Slot = SpellSlot.W, Type = SpellType.Targeted });
